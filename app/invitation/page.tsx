...
import { playball, workSans } from '../ui/fonts';
...
export default function InvitationPage() {
  ...
  useEffect(() => {
    const sections = document.querySelectorAll(".invitation-body section");
  ...
  return (
    <main className={workSans.className + " bg-slate-100 dark:bg-slate-800"}>
      <section id='hero' className="hero h-screen flex flex-col items-center justify-center">
        ...
        <h1 className={playball.className + ' text-pink-600 text-5xl mb-2'}>Shandika & Nofariza</h1>
      ...
      <div className='relative invitation-body'>
        <nav className="bg-pink-400 sticky top-0 z-[1050]">
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex shrink-0 items-center">
                  <p className={playball.className + ' text-3xl text-white'}>emvite</p>
                </div>
        ...
        <section id='invitation-home' className="min-h-screen flex flex-col justify-center -mt-16 pt-16 opacity-0 transform translate-y-10 transition-all duration-700">
          <div className="mx-auto max-w-2xl px-2 sm:px-6 lg:px-8 mb-24 mt-10">
            <h2 className={playball.className + ' text-pink-600 text-5xl text-center mb-3'}>Acara Pernikahan</h2>
            ...
            <div className="flex gap-10 lg:gap-4 flex-col lg:flex-row">
              <div className='flex flex-1 gap-4 lg:flex-row-reverse'>
                ...
                <div className='flex-1'>
                  <h3 className={playball.className + ' text-4xl font-bold mb-2 text-pink-600 text-left lg:text-right'}>Shandika Galih</h3>
              ...
              <div className='flex flex-1 gap-4 lg:flex-row-reverse'>
                <div className='flex-1'>
                  <h3 className={playball.className + ' text-4xl font-bold mb-2 text-pink-600 text-right lg:text-left'}>Nofariza</h3>
        ...
        <div
          className={`z-[1050] fixed top-0 right-0 h-full w-64 bg-white dark:bg-slate-800 shadow-lg transform transition-transform duration-300 ease-in-out ${!isOpen ? 'translate-x-full' : 'translate-x-0'}`}
        >
          <div className="p-4 flex justify-between items-center">
            <p className={playball.className + ' text-3xl text-pink-600 dark:text-white'}>emvite</p>
